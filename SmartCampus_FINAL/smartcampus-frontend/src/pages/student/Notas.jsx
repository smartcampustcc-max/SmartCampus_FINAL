...
export default function NotasAluno() {
  ...
  const faltasFiltradas = useMemo(() => {
    return faltas.filter((f) => {
      const mesmaDisciplina = !disciplinaFiltro || f.disciplina === disciplinaFiltro;
      const mesmoTrimestre = !trimestreFiltro || getTrimestre(f.data) === trimestreFiltro;
      ...
      <div style={styles.duasColunas}>
        <div style={styles.card}>
          <div style={styles.sectionHeader}>
            <div>
              <div style={styles.cardTitle}>Notas</div>
        ...
        <div style={styles.card}>
          <div style={styles.sectionHeader}>
            <div>
              <div style={styles.cardTitle}>Faltas registadas</div>
              <div style={styles.muted}>Faltas marcadas pelos professores.</div>
            </div>
          ...
          <div style={{ marginTop: 12, overflowX: "auto" }}>
            <table style={styles.tableFaltas}>
              <thead>
                <tr>
